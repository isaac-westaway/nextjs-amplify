...
export default function ContactForm() {
  ...
  return (
    <div className="flex flex-col border max-w-60 mx-10 space-y-11">
      ...
      <input type="checkbox" name="booleanValue" onClick={handleBooleanChange} checked={values.booleanValue} className="border-b-[3px] border-black" placeholder="booleanValue"/>
